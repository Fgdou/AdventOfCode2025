...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `53.0µs` | `2.0ms` |
| [Day 2](./src/bin/02.rs) | `26.2ms` | `433.8ms` |
| [Day 3](./src/bin/03.rs) | `230.2µs` | `259.9µs` |
| [Day 4](./src/bin/04.rs) | `26.0ns` | `36.0ns` |
| [Day 5](./src/bin/05.rs) | `103.9µs` | `43.4µs` |
| [Day 6](./src/bin/06.rs) | `52.6µs` | `126.9µs` |
| [Day 7](./src/bin/07.rs) | `679.2µs` | `577.9µs` |
| [Day 8](./src/bin/08.rs) | `35.6ms` | `7.6s` |
| [Day 9](./src/bin/09.rs) | `647.6µs` | `140.5ms` |
| [Day 10](./src/bin/10.rs) | `2.0s` | `164.9ms` |
| [Day 11](./src/bin/11.rs) | `219.3µs` | `612.2µs` |
| [Day 12](./src/bin/12.rs) | `191.6µs` | `-` |
